...
rm pathsTernarySearchTree pathsTrie
g++ -o pathsTernarySearchTree pathsTernarySearchTree.cpp
g++ -o pathsTrie pathsTrie.cpp
...
do
	...
	./pathsTrie ${DATAFOLDER}${filename} >> ${OUTPUTFILE}
	./pathsTernarySearchTree ${DATAFOLDER}${filename} >> ${OUTPUTFILE}
done
