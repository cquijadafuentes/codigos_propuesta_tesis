...
bool noIguales(bool a, bool b, bool c, bool d){
	if(a != b || b != c || c != d){
		return true;
	}
	return false;
...
int main(int argc, char const *argv[]){
    ...
    string rNaive, rNaivePC, rGST_0, rGST_1;
    for(int i = 0; i < routes.size(); i++){
        for(int j = 0; j < routes.size(); j++){
            ...
            if(rNaive != rNaivePC || rNaivePC != rGST_0 || rGST_1 != rGST_0){
            	cout << "i: " << i << " - j: " << j << endl;
            ...
            if(noIguales(trWith, trpcWith, tt0With, tt1With) ||
            		noIguales(trCont, trpcCont, tt0Cont, tt1Cont) ||
            		noIguales(trInte, trpcInte, tt0Inte, tt1Inte)){
            	cout << "\tNaive\tNaivePC" << endl;
            	cout << "With\t" << trWith << "\t" << trpcWith << "\t" << tt0With << "\t" << tt1With << endl;
            	cout << "Cont\t" << trCont << "\t" << trpcCont << "\t" << tt0Cont << "\t" << tt1Cont << endl;
            	cout << "Inte\t" << trInte << "\t" << trpcInte << "\t" << tt0Inte << "\t" << tt1Inte << endl;
            	cout << "Rel\t" << rNaive << "\t" << rNaivePC << "\t" << rGST_0 << "\t" << rGST_1 << endl;
            	cout << "\t(" << routes[i].size() << "): ";
	            for(int x=0; x<routes[i].size(); x++){
	            	cout << routes[i][x] << " ";
	            }
