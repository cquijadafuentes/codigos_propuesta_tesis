...
echo "***************** Madrid *****************" > ~/resultados_2023-01-09_allContainMadrid.txt
...
echo "***************** Madrid_x2 *****************" >> ~/resultados_2023-01-09_allContainMadrid.txt
...
echo "***************** Madrid_x4 *****************" >> ~/resultados_2023-01-09_allContainMadrid.txt
...
echo "***************** Madrid_x8 *****************" >> ~/resultados_2023-01-09_allContainMadrid.txt
